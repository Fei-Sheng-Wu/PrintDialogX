...
namespace PrintDialogX.Test
{
    public partial class MainWindow : Window
    {
        ...
        private StackPanel CreateContent(int pageNumber, double width, double height, double margin)
        {
            ...
            stackPanel.Children.Add(new Image() { Source = new System.Windows.Media.Imaging.BitmapImage(new Uri("/PrintDialog;component/Resources/LoadingImage.png", UriKind.Relative)), Margin = new Thickness(10, 5, 10, 5), Width = 200, Height = 200, HorizontalAlignment = HorizontalAlignment.Center });
