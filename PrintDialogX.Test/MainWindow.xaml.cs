...
namespace PrintDialogX.Test
{
    public partial class MainWindow : Window
    {
        ...
        private StackPanel GeneratePageContent(int pageNumber, double customWidth, double customHeight, double customMargin)
        {
            ...
            stackPanel.Children.Add(new TextBlock() { Text = $"These are some updating text: Width {customWidth} px | Height {customHeight} px | Margin {customMargin} px", FontSize = 18, HorizontalAlignment = HorizontalAlignment.Center, Margin = new Thickness(10, 5, 10, 35) });
            ...
            stackPanel.Children.Add(new Image() { Source = System.Windows.Interop.Imaging.CreateBitmapSourceFromHIcon(System.Drawing.SystemIcons.WinLogo.Handle, Int32Rect.Empty, System.Windows.Media.Imaging.BitmapSizeOptions.FromEmptyOptions()), Width = 200, Height = 200, HorizontalAlignment = HorizontalAlignment.Center, Margin = new Thickness(10, 5, 10, 5) });
