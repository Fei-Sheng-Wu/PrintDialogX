    ...
    public class PrintDialog
    {
        ...
        public void LoadingEnd()
        {
            if (PrintWindow != null)
            {
                ...
                if (Document.Pages.Count == 0)
                {
                    throw new PrintDialogExceptions.DocumentEmptyException("The document is empty.", Document);
                }

                PrintWindow.NavigatePrintPage(Document, DocumentName, DocumentMargin, DefaultSettings, AllowPagesOption, AllowScaleOption, AllowDoubleSidedOption, AllowPagesPerSheetOption, AllowPageOrderOption, AllowMoreSettingsExpander, AllowAddNewPrinterButton, AllowPrinterPreferencesButton, CustomReloadDocumentMethod);
            }
        }
    }
}
