...
namespace PrintDialogX
{
    public class PrintDocument
    {
        ...
        /// <summary>
        /// Set the <see cref="DocumentSize"/> by values in inches.
        ...
        /// <summary>
        /// Create a <see cref="PrintDocument"/> from a <see cref="FixedDocument"/>.
        /// <param name="document">The instance of <see cref="FixedDocument"/>.</param>
    ...
    public class PrintPage
    {
        ...
        public UIElement Content
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("The value is already the child of another element.");
                }
                else
                {
                    _content = value;
...
{
    internal class MultiPagesPerSheet
    {
        ...
        public MultiPagesPerSheet(List<FixedPage> document, PrintSettings.PagesPerSheet pagesPerSheet, Size documentSize, PrintSettings.PageOrder pageOrder, PrintSettings.PageOrientation documentOrientation)
        {
            _document = document;
